...
>
> **Consolidation review done** (2026-05-02 night):
> [`docs/KOS-JARVIS-CONSOLIDATION-PLAN.md`](../../docs/KOS-JARVIS-CONSOLIDATION-PLAN.md)
> 写就 — 16 fork skill 全 audit,5 个 decision bucket,M1
> milestone 拆 4 项 P1 落地任务。Net target: **16 active → 11
> active + 2 archived + 1 retired** by v0.26.0 sync window。下个
> session 起手没有 P0 fire,只有 P1 落地清单。
>
...
_(empty — v0.25.0 收口完成,consolidation PLAN 已写,P0 全清。下个
session 起手只剩 P1 list。)_

## P1 — consolidation PLAN 落地 (M1 milestone)
