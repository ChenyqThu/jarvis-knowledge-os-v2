 ...
 */
const DIR_PATTERN = '(?:people|companies|meetings|concepts|deal|civic|project|projects|sources|source|media|yc|tech|finance|personal|openclaw|entities|reference)';
